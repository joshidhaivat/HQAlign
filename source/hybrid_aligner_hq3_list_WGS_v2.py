...
def hybrid_alignment(i):
    ...
    os.system('minimap2 -ax map-ont -t '+str(minimap2_threads)+' --MD -k '+str(kmer)+' -q '+new_dir+'test_rc_read_'+pid+'.fasta '+new_dir+'test_ref_'+pid+'.fasta '+new_dir+'test_read_'+pid+'.fasta > '+new_dir+'test_align_'+pid+'.sam')
