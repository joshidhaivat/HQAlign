...
def main():
    ...
    for afile in os.listdir(args.reads):
        if afile.endswith('.fasta'):
            ...
            command_line = 'softwares/minimap2-2.24/minimap2 -ax map-ont --MD -t {} {} {} > {}'.format(args.threads,args.ref,read_file,samfile)
            os.system(command_line)
            command_line = 'softwares/k8-0.2.4/k8-Linux softwares/minimap2-2.24/paftools.js sam2paf {} > {}'.format(samfile,paffile)
            os.system(command_line)
    ...
    command_line = 'python convert_seq.py {} {} {} {} {} {} {} {}'.format(args.ref,3,1,args.threads,outdir,1,outfile,outfile_rc)
    os.system(command_line)
    ...
    for afile in os.listdir(args.reads):
        if afile.endswith('.fasta'):
            ...
            command_line = 'python convert_seq.py {} {} {} {} {} {} {} {}'.format(read_file,3,1,args.threads,outdir,0,outfile,outfile_rc)
            os.system(command_line)
    ...
    for afilename in os.listdir(workdir):
        if afilename.endswith('.paf'):
            ...
            command_line = 'python hybrid_aligner_hq3_list_WGS_v2.py {} {} {} {} {} {} {} {} {} {} {}'.format(outdir,ref_file,rc_ref_file,
